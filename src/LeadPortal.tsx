  ...
  return (
    <div className="portal">
      ...
      <main className="portal-main">
        ...
        {/* ── Page title ── */}
        <div className="page-title-area a2">
          <div>
            <h1 className="lead-name">{data.name}</h1>
            <div className="lead-meta-row">
              {data.caseType && <span className="case-badge">{data.caseType}</span>}
              <span className="created-at">{createdAt}</span>
            </div>
          </div>
          <div className="score-badge">
            <span className="score-dot" />
            {data.score.toUpperCase()} · {data.scoreValue}/20
          </div>
        </div>
            ...
            <GlowCard className="a4 glow-hover">
              <div className="card">
                ...
                <div className="score-bar-track">
                  <div className="score-bar-fill" style={{ width: `${scoreBarPct}%` }} />
                </div>

                <div className="intel-grid" style={{ marginTop: 16 }}>
                  <div className="intel-row">
                    <span className="intel-label">Score</span>
                    <span className="intel-value">
                      {data.score.charAt(0).toUpperCase() + data.score.slice(1)} · {data.scoreValue}/20
                    </span>
                  </div>
                  <div className="intel-row">
                    <span className="intel-label">Urgency</span>
                    <span className="intel-value">
                      {URGENCY_LABEL[data.urgencyLevel ?? "none"] ?? data.urgencyLevel ?? "—"}
                    </span>
                  </div>
                  {data.caseType && (
                    <div className="intel-row">
                      <span className="intel-label">Matter</span>
